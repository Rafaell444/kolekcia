  ...
  return (
    <SiteShell>
      <article className="dp-container py-8 max-w-3xl">
        <nav className="flex items-center gap-2 text-[12px] text-dp-text-tertiary mb-6 flex-wrap" aria-label="Breadcrumb">
          <Link href="/" className="hover:text-dp-text-primary transition-colors">Home</Link>
          <span>/</span>
          <Link href="/blog" className="hover:text-dp-text-primary transition-colors">Blog</Link>
          <span>/</span>
          <span className="text-dp-text-secondary truncate">{post.title}</span>
        </nav>
