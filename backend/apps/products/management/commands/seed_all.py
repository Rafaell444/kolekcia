...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        self.stdout.write(self.style.MIGRATE_HEADING("=== Koleqcia Full Seed ==="))
    ...
    def _seed_users(self):
        ...
        # Staff / artist users
        staff = [
            ("vendor1@koleqcia.com", "Panel Studio",  "vendor12345",   "staff", True,  "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=80&h=80&fit=crop&crop=face"),
            ("vendor2@koleqcia.com", "Figure Studio", "vendor12345",   "staff", True,  "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=80&h=80&fit=crop&crop=face"),
            ("super@koleqcia.com",  "Superadmin",    "AdminPass123!", "staff", True,  "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&crop=face"),
        ]
        ...
        customers = [
            ...
            ("bob@example.com",     "Bob Muller",    "Test1234!", "https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=80&h=80&fit=crop&crop=face", 750),
    ...
    def _seed_artists(self):
        ...
        artists_data = [
            ...
            (
                ...
                89, 9200, 18, "Gold", True, "vendor1@koleqcia.com", "panel-studio",
            ),
        ]
    ...
    def _sync_tenants(self):
        ...
        tenant_specs = [
            ("wallpanels", "Wallpanels", "panel-studio", "vendor1@koleqcia.com"),
            ("figures", "Figures", "figure-studio", "vendor2@koleqcia.com"),
        ]
