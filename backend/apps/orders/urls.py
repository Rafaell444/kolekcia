...
urlpatterns = [
    ...
    path("cart/reprice/", CartRepriceView.as_view(), name="cart-reprice"),
    ...
    path("cart/shipping-options/", CartShippingOptionListView.as_view(), name="cart-shipping-options"),
