// ============================================================
// Koleqcia — Multi-Tenant Data Layer
// Two separate vendor tenants + superadmin aggregation
// ============================================================

export type TenantId = "Koleqcia" | "noir"
...
export const TENANT_PRODUCTS: TenantProduct[] = [
  // Koleqcia products
  { id: "kp1", tenantId: "Koleqcia", title: "Neon Dragon",        artistName: "Kaoru Nishida",  imageUrl: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=400&h=560&fit=crop", price: 29.99, category: "Anime",   isLimited: false, isSale: true,  isNew: false, stock: 214 },
  { id: "kp2", tenantId: "Koleqcia", title: "Midnight Circuit",   artistName: "Alex Tanaka",    imageUrl: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=560&fit=crop", price: 34.99, category: "Gaming",  isLimited: true,  isSale: false, isNew: false, stock: 42  },
  { id: "kp3", tenantId: "Koleqcia", title: "Void Between Stars", artistName: "Selene Varga",   imageUrl: "https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=400&h=560&fit=crop", price: 34.99, category: "Space",   isLimited: false, isSale: false, isNew: true,  stock: 180 },
  { id: "kp4", tenantId: "Koleqcia", title: "Iron Tiger",         artistName: "Marcus Steele",  imageUrl: "https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=400&h=560&fit=crop", price: 27.99, category: "Nature",  isLimited: false, isSale: true,  isNew: false, stock: 95  },
  { id: "kp5", tenantId: "Koleqcia", title: "Aurora Drift",       artistName: "Hana Kurosawa",  imageUrl: "https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=400&h=560&fit=crop", price: 49.99, category: "Space",   isLimited: false, isSale: false, isNew: false, stock: 320 },
  // Noir products
...
export const TENANT_ORDERS: TenantOrder[] = [
  // Koleqcia orders
  { id: "ko1", tenantId: "Koleqcia", orderNumber: "KOL-001", customerName: "James Park",    customerEmail: "james@example.com",   items: 2, total: 64.98,  status: "delivered",  date: "2026-06-18", createdAt: "2026-06-18T09:14:00Z", trackingCode: "USPS123456789", product: "Neon Dragon × 2"         },
  { id: "ko2", tenantId: "Koleqcia", orderNumber: "KOL-002", customerName: "Mia Hoffman",   customerEmail: "mia@example.com",     items: 1, total: 34.99,  status: "shipped",    date: "2026-06-19", createdAt: "2026-06-19T11:22:00Z", trackingCode: "FEDEX987654",       product: "Midnight Circuit"       },
  { id: "ko3", tenantId: "Koleqcia", orderNumber: "KOL-003", customerName: "Tom Fletcher",  customerEmail: "tom@example.com",     items: 3, total: 99.97,  status: "processing", date: "2026-06-20", createdAt: "2026-06-20T14:05:00Z",                                     product: "Iron Tiger × 3"         },
  { id: "ko4", tenantId: "Koleqcia", orderNumber: "KOL-004", customerName: "Sofia Reyes",   customerEmail: "sofia@example.com",   items: 1, total: 49.99,  status: "pending",    date: "2026-06-21", createdAt: "2026-06-21T08:30:00Z",                                     product: "Aurora Drift"           },
  { id: "ko5", tenantId: "Koleqcia", orderNumber: "KOL-005", customerName: "Yuki Tanaka",   customerEmail: "yuki@example.com",    items: 2, total: 69.98,  status: "delivered",  date: "2026-06-22", createdAt: "2026-06-22T10:18:00Z", trackingCode: "DHL11223344",       product: "Void Between Stars × 2" },
  { id: "ko6", tenantId: "Koleqcia", orderNumber: "KOL-006", customerName: "Emma Laurent",  customerEmail: "emma@example.com",    items: 1, total: 29.99,  status: "cancelled",  date: "2026-06-23", createdAt: "2026-06-23T07:55:00Z",                                     product: "Neon Dragon"            },
  // Noir orders
...
export const TENANT_PAYMENTS: TenantPayment[] = [
  // Koleqcia payments
  { id: "kpay1", tenantId: "Koleqcia", orderNumber: "KOL-001", customerName: "James Park",   amount: 64.98,  fee: 2.14, net: 62.84,  method: "card",       status: "paid",     date: "2026-06-18" },
  { id: "kpay2", tenantId: "Koleqcia", orderNumber: "KOL-002", customerName: "Mia Hoffman",  amount: 34.99,  fee: 1.29, net: 33.70,  method: "paypal",     status: "paid",     date: "2026-06-19" },
  { id: "kpay3", tenantId: "Koleqcia", orderNumber: "KOL-003", customerName: "Tom Fletcher", amount: 99.97,  fee: 3.20, net: 96.77,  method: "apple_pay",  status: "pending",  date: "2026-06-20" },
  { id: "kpay4", tenantId: "Koleqcia", orderNumber: "KOL-004", customerName: "Sofia Reyes",  amount: 49.99,  fee: 1.74, net: 48.25,  method: "card",       status: "pending",  date: "2026-06-21" },
  { id: "kpay5", tenantId: "Koleqcia", orderNumber: "KOL-005", customerName: "Yuki Tanaka",  amount: 69.98,  fee: 2.34, net: 67.64,  method: "google_pay", status: "paid",     date: "2026-06-22" },
  { id: "kpay6", tenantId: "Koleqcia", orderNumber: "KOL-006", customerName: "Emma Laurent", amount: 29.99,  fee: 0,    net: 0,      method: "card",       status: "refunded", date: "2026-06-23" },
  // Noir payments
