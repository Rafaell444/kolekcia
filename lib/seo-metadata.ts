...
export const HOMEPAGE_SEO: LocalizedSEO = {
  en: {
    title: "Unique Gifts, Anime & Gaming Decor Made in Georgia | Koleqcia",
  ...
  ka: {
    title: "ანიმე, თამაშები და უნიკალური საჩუქრები | Koleqcia",
  ...
  ru: {
    title: "Аниме Декор и Необычные Подарки в Грузии | Koleqcia",
...
export const AUCTIONS_SEO: LocalizedSEO = {
  en: {
    title: "Exclusive Anime & Gaming Decor Auctions | Koleqcia",
  ...
  ru: {
    title: "Аукционы Эксклюзивного Аниме Декора | Koleqcia",
...
export const FAQ_SEO: LocalizedSEO = {
  ...
  ru: {
    title: "Вопросы и Ответы (FAQ) | Koleqcia",
...
export const SHIPPING_SEO: LocalizedSEO = {
  ...
  ru: {
    title: "Информация о Доставке | Koleqcia",
...
export const RETURNS_SEO: LocalizedSEO = {
  en: {
    title: "Returns & Refunds Policy | Koleqcia",
  ...
  ka: {
    title: "დაბრუნების პირობები | Koleqcia",
...
export const COOKIES_SEO: LocalizedSEO = {
  ...
  ka: {
    title: "Cookie პოლიტიკა | Koleqcia",
  ...
  ru: {
    title: "Политика Использования Файлов Cookie | Koleqcia",
...
export const TERMS_SEO: LocalizedSEO = {
  en: {
    title: "Terms of Service | Koleqcia",
