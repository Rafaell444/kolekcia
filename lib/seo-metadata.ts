...
export const HOMEPAGE_SEO: LocalizedSEO = {
  ...
  ru: { title: "Аниме Декор и Необычные Подарки в Грузии", description: "Ищете необычный подарок геймеру или любителю аниме? Уникальный игровой декор, фигурки и деревянные панно ручной работы. Сделано в Грузии." },
}
...
export const CATALOG_SEO: LocalizedSEO = {
  ...
  ru: { title: "Каталог Аниме Фигурок и Игрового Декора", description: "Смотрите каталог Koleqcia: аниме фигурки ручной работы, деревянные панно и декор для игровой комнаты. Уникальные подарки из Грузии." },
}
...
export const ABOUT_SEO: LocalizedSEO = {
  ...
  ru: { title: "О Нас | Koleqcia - Аниме Декор Ручной Работы в Грузии", description: "Узнайте больше о Koleqcia. Мы создаем уникальные фигурки и деревянные панно для геймеров и любителей аниме. Сделано в Грузии." },
}
...
export const CUSTOM_SEO: LocalizedSEO = {
  ...
  ru: { title: "Фигурки и Постеры на Заказ | Необычный Подарок от Koleqcia", description: "Ищете необычный подарок? Закажите фигурки и настенное панно ручной работы по вашему дизайну. Идеальный кастомный декор для игровой комнаты." },
}
...
export const AUCTIONS_SEO: LocalizedSEO = {
  ...
  ru: { title: "Аукционы Эксклюзивного Аниме Декора", description: "Участвуйте в аукционах Koleqcia! Выигрывайте редкие аниме фигурки и эксклюзивное деревянное панно ручной работы по лучшей цене." },
}
...
export const BLOG_SEO: LocalizedSEO = {
  ...
  ru: { title: "Блог Koleqcia | Идеи Подарков и Декор для Игровой Комнаты", description: "Читайте блог Koleqcia: лучшие идеи необычных подарков для геймеров, советы по обустройству игровой комнаты и обзоры аниме новинок." },
}
...
export const CONTACT_SEO: LocalizedSEO = {
  ...
  ru: { title: "Контакты | Служба Поддержки Koleqcia", description: "У вас есть вопросы о заказе, фигурках или деревянных панно? Свяжитесь с командой Koleqcia. Мы всегда рады помочь!" },
}
...
export const ARTISTS_SEO: LocalizedSEO = {
  ...
  ru: { title: "Наши Художники | Создатели Аниме и Игрового Декора", description: "Познакомьтесь с художниками Koleqcia. Уникальный игровой декор, фигурки и деревянные панно ручной работы от лучших авторов." },
}
...
export const FAQ_SEO: LocalizedSEO = {
  ...
  ru: { title: "Вопросы и Ответы (FAQ)", description: "У вас есть вопросы о кастомных фигурках, деревянных панно или доставке? Найдите ответы в FAQ Koleqcia." },
}
...
export const SHIPPING_SEO: LocalizedSEO = {
  ...
  ru: { title: "Информация о Доставке", description: "Узнайте о правилах доставки Koleqcia. Мы надежно упаковываем и доставляем ваши аниме фигурки и деревянный декор для стен." },
}
...
export const RETURNS_SEO: LocalizedSEO = {
  ...
  ru: { title: "Возврат и Обмен | Политика Koleqcia", description: "Ознакомьтесь с политикой возврата Koleqcia. Мы хотим, чтобы вы были полностью довольны своими необычными подарками и декором." },
}
...
export const COOKIES_SEO: LocalizedSEO = {
  ...
  ru: { title: "Политика Использования Файлов Cookie", description: "Информация о том, как Koleqcia использует файлы cookie для улучшения работы сайта и вашего удобства." },
}
...
export const PRIVACY_SEO: LocalizedSEO = {
  ...
  ru: { title: "Политика Конфиденциальности", description: "Узнайте, как Koleqcia защищает ваши данные и конфиденциальность при покупке аниме подарков и декора." },
}
...
export const TERMS_SEO: LocalizedSEO = {
  ...
  ru: { title: "Условия Использования", description: "Ознакомьтесь с условиями предоставления услуг Koleqcia. Информация об использовании сайта и покупке декора." },
}
